...
namespace CloudflareDNS
{
    internal class Program
    {
        ...
        private static async Task UpdateAsync()
        {
            ...
            {
                CloudflareRecord record = await cfApi.GetDnsRecordAsync(Properties.Settings.Default.ZoneID, Properties.Settings.Default.DefaultRecordID);
                ...
                _ = table.AddRow(record.Name, record.Type);
